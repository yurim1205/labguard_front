...
const imgs = {
  manual: <img src="/assets/img/manual.png" alt="매뉴얼" className="w-[96px] h-[96px] mt-[96px]" />,
...
function MenuCard({ img, title, desc, link }) {
  // 카드별로 흰색 박스의 paddingTop 조절
  let containerStyle = { width: "210px", height: "160px", paddingTop: "0px" };

  if (title === "매뉴얼 등록 및 분석" || title === "실험하기") {
    containerStyle = { width: "210px", height: "200px", paddingTop: "48px" }; // 위쪽 공간 늘림
