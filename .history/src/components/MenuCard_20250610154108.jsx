...
function MenuCard({ img, title, desc, link }) {
  // 카드별로 흰색 박스 높이 조절
  let containerStyle = { width: "210px", height: "140px" }; // 더 낮게

  if (title === "매뉴얼 등록 및 분석" || title === "실험하기") {
    containerStyle = { width: "210px", height: "140px" }; // 동일하게 맞춤
  ...
  return (
    <Link
      to={link}
      className="block bg-[#EBEAE5] w-[360px] h-[320px] rounded-xl shadow-md p-10 pt-8 hover:shadow-lg transition-shadow duration-200 no-underline"
    >
