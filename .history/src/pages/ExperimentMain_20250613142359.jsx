          ...
          <h2 className="text-[20px] font-bold mb-3 text-left font-[500]">내 실험</h2>
            <ul className="bg-white border border-[#b5b5b5] rounded-[10px] py-4 list-none m-0 mt-[1px]">
                {manuals.map((m, i) => (
                    ...
                    >
                    <span className="text-[#33308B] text-[0.95rem] mb-1 mr-[40px] px-[10px] py-[10px] bg-[#ECECE7] rounded-[10px]">{m.date}</span>
                    <span className="text-[#33308B] font-semibold px-[10px] py-[10px] bg-[#ECECE7] rounded-[10px]">{m.name}</span>
                    </li>
                ))}
            </ul>
        </section>
