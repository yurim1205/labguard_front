        ...
        <div className="bg-white rounded-[40px] shadow-xl px-10 py-12 w-full max-w-[400px] flex flex-col items-start">
          ...
          <form onSubmit={handleSubmit} className="items-center w-full flex flex-col justify-center ml-[50px] space-y-[12px]">
            ...
            <div>
              ...
              />
              {formTouched && errorMessages.name && (
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
              />
              {formTouched && errorMessages.email && (
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
              />
              {formTouched && errorMessages.password && (
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
              />
              {formTouched && errorMessages.company_id && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.company_id}</p>
              )}
            </div>

            {/* 일반 에러 */}
            {formTouched && errorMessages.general && (
              <p className="text-red-600 text-center text-sm mt-2">{errorMessages.general}</p>
            )}
