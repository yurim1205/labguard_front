...
function Login() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#B4D1FD] gap-8">
      ...
      <div className="flex flex-col w-[400px] justify-center items-center mt-[100px]">
        {/* 이메일 */}
        <div className="mb-8">
          {/* <label className="block mb-2 text-gray-400 text-lg">이메일</label> */}
          <input
            className="border border-blue-400 rounded-full px-5 py-4 focus:outline-none focus:ring-2 focus:ring-blue-300 text-lg"
            type="email"
            name="email"
          />
        </div>
