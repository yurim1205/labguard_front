    ...
    <>
      ...
      <div className="max-w-[1200px] mx-auto pt-10 pb-12">
        ...
        <section className="bg-[#ecece7] rounded-lg p-10 mb-10 pt-[24px]">
          <div className="border border-dashed border-[#b5b5b5] rounded-lg bg-[#FFFFFF]  min-h-[420px] flex flex-col items-center justify-center p-10 max-w-[520px] mx-auto">
            <div className="font-bold text-[1.05rem] mb-[12px]">첨부할 파일 드래그</div>
            <div className="text-base text-[#222] mb-5">또는</div>
            <label
              htmlFor="file-upload"
              className="inline-block bg-white text-[#234c36] border border-[#234c36] mt-[12px] rounded px-6 py-2 font-semibold text-base cursor-pointer mt-2 transition-colors duration-200 hover:bg-[#234c36] hover:text-white"
            >
              파일 선택
            </label>
            <input id="file-upload" type="file" ref={fileInputRef} className="hidden" />
          </div>
          <div className="text-[#888] text-sm mt-5 text-left leading-6 mt-10 text-center">
