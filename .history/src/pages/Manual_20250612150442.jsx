        ...
        <section className="bg-[#ecece7] rounded-lg p-10 mb-10 pt-[24px]">
          <div className="max-w-[520px] mx-auto">
            <div className="border border-dashed border-[#b5b5b5] rounded-lg bg-[#FFFFFF] shadow-[0_6px_12px_0_rgba(128,128,128,0.28)] min-h-[360px] flex flex-col items-center justify-center p-10 text-center gap-3">
              <div className="font-extrabold text-[1.05rem] text-[#0E467B] font-pretendard">첨부할 파일 놓기</div>
              <div className="text-base text-[#798483]">또는</div>
              <label
                htmlFor="file-upload"
                className="inline-block bg-white text-[#0E467B] border border-[#0E467B] rounded px-6 py-2 font-semibold text-base cursor-pointer transition-colors duration-200 hover:bg-[#234c36] hover:text-white"
              >
                파일 선택
              </label>
