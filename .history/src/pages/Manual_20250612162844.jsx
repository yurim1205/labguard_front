    ...
    <>
      ...
      <div className="max-w-[1200px] mx-auto pt-10 pb-12">
        ...
        <section className="mt-[48px]">
          ...
          <div className="flex">
            <button
              className="rounded-t-[10px] px-9 py-3 font-bold text-[1.05rem] tracking-tight bg-[#33308B] text-[#FFFFFF] border border-[#b5b5b5] border-b-0"
            >
              실험
            </button>
          </div>

          <ul className="bg-white border border-[#b5b5b5] rounded-b-lg rounded-t-none py-2 list-none m-0 mt-[1px]">
            {manuals.map((m, i) => (
              <li
                key={i}
