...
function MenuCard({ img, title, desc, link }) {
  ...
  return (
    <Link
      to={link}
      className="block bg-[#EBEAE5] w-[360px] h-[320px] rounded-[5px] shadow-[0_12px_24px_0_rgba(128,128,128,0.35)] p-10 hover:shadow-lg transition-shadow duration-200 no-underline"
    >
