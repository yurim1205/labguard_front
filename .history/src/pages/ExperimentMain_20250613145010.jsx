    ...
    <>
      ...
      <div className="max-w-[1200px] mx-auto pt-10 pb-12">
        ...
        <section className="mt-[48px]">
          ...
          {/* 탭 */}
          <div className="flex border-b border-[#b5b5b5] mb-4">
            <button
              onClick={() => setActiveTab('ongoing')}
              className={`rounded-t-md px-6 py-2 text-sm font-bold mr-2
                ${
                  activeTab === 'ongoing'
                    ? 'bg-[#33308B] text-white'
            ...
            <button
              ...
              className={`rounded-t-md px-6 py-2 text-sm font-bold
                ${
                  activeTab === 'completed'
                    ? 'bg-[#33308B] text-white'
                    : 'bg-[#E6EEFF] text-[#1C1C59]'
                }`}
            >
              실험종료
            </button>
            ...
            {filteredManuals.map((m, i) => (
              ...
              >
                <div className="flex gap-8 items-center">
                  <span className="text-[#33308B] text-[0.95rem]">{m.date}</span>
