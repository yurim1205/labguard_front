      ...
      <div className="max-w-[1200px] mx-auto pt-10 pb-12">
        ...
        <section className="bg-[#ecece7] rounded-lg p-10 mb-10 pt-[24px]">
          <div className="max-w-[520px] mx-auto">
            <div className="border border-dashed border-[#b5b5b5] rounded-lg bg-[#FFFFFF] min-h-[420px] flex flex-col items-center justify-center p-10 text-center gap-3">
            ...
            <div className="text-[#888] text-sm mt-4 text-left leading-6">
