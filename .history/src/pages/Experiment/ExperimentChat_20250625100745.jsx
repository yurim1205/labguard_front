...
function ExperimentChat() {
  ...
  const connectWebSocket = () => {
    ...
    console.log('WebSocket 연결 시도:', 'ws://localhost:8000/api/ws/agent-chat');
  ...
  const handleSend = async () => {
    ...
    if (socketRef.current && socketRef.current.readyState === WebSocket.OPEN) {
      ...
      console.log('디버깅 - experimentDetails:', experimentDetails);
      console.log('디버깅 - manual_id 값:', experimentDetails.manual?.manual_id);
      console.log('디버깅 - manual id 값:', experimentDetails.manual?.id);
