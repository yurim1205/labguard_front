...
function MenuCard({ img, title, desc, link }) {
  // 카드별로 컨테이너 크기 지정
  let containerStyle = { width: "200px", height: "150px" }; // 기본값

  if (title === "매뉴얼 등록 및 분석") {
    containerStyle = { width: "180px", height: "120px" };
  } else if (title === "실험하기") {
    containerStyle = { width: "170px", height: "130px" };
  } else if (title === "리포트 확인") {
    containerStyle = { width: "210px", height: "140px" };
  }
