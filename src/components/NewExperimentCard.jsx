...
const NewExperiment = ({ onClick }) => {
  ...
  >
    <div className="flex flex-col items-center justify-between h-full">
      ...
      >
        <img src={newExperiment} alt="새 실험 아이콘" className="w-[96px] h-[96px] mt-[42px] object-contain" />
      </div>
      <div className="text-center mt-4">
        <h3 className="text-xl font-bold text-[#33308B] -mt-[110px]">새 실험 생성</h3>
        <p className="text-gray-600 text-base">새로운 실험을 등록할 수 있습니다.</p>
      </div>
    </div>
  </div>
