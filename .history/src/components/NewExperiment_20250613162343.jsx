...
const NewExperiment = () => {
  ...
  return (
    <div
    onClick={handleClick}
    className="h-[306px] w-[380px] border border-[#b5b5b5] rounded-[4px] shadow-[0_6px_12px_0_rgba(128,128,128,0.28)] p-5 cursor-pointer hover:shadow-md transition duration-200"
  >
