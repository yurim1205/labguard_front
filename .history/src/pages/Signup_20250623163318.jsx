...
const signupSchema = z.object({
  ...
  password: z.string()
    .min(8, "비밀번호는 8자 이상이며, 숫자와 특수 문자를 포함해주세요.")
    .regex(/(?=.*[0-9])/, "비밀번호는 8자 이상이며, 숫자와 특수 문자를 포함해주세요.")
    .regex(/(?=.*[!@#$%^&*])/, "비밀번호는 8자 이상이며, 숫자와 특수 문자를 포함해주세요."),
...
function Signup() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-[#5D93E4] to-[#E2ECFF] gap-8 relative">
      ...
      />
      <div className="w-[500px] h-[800px] rounded-[40px] shadow-md items-center justify-start bg-[#FFFFFF] shadow-[0_12px_24px_0_rgba(128,128,128,0.35)]">
        <div className="bg-white rounded-[40px] shadow-xl px-10 py-12 w-full max-w-[400px] flex flex-col items-start">
          ...
          <form onSubmit={handleSubmit} className="items-center w-full flex flex-col justify-center ml-[50px] space-y-[12px]">
            ...
            <div>
              ...
              />
              {errorMessages.name && (
                <p className="text-[#C9240E] text-[12px] mt-1">{errorMessages.name}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.email && (
                <p className="text-[#C9240E] text-[12px] mt-1">{errorMessages.email}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errorMessages.password && (
                <p className="text-[#C9240E] text-[12px] mt-1">{errorMessages.password}</p>
              )}
            </div>
            ...
            {formTouched && errorMessages.general && (
              <p className="text-[#C9240E] text-center text-[12px] mt-2">{errorMessages.general}</p>
            )}
