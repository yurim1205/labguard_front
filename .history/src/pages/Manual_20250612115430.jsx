  ...
  return (
    <>
      ...
      <div className="max-w-[1200px] mx-auto pt-10 pb-12">
        ...
        {/* 실험 업로드 영역 */}
        <section className="bg-[#ecece7] rounded-lg p-10 mb-10 mt-[24px]">
          <div className="border border-dashed border-[#b5b5b5] rounded-lg bg-[#FFFFFF] mt-[24px] min-h-[420px] flex flex-col items-center justify-center p-10 max-w-[520px] mx-auto">
