...
const imgs = {
  manual: <img src="/assets/manual.png" alt="매뉴얼" className="w-[96px] h-[96px]" />,
  lab: <img src="/assets/lab.png" alt="실험" className="w-[96px] h-[96px]" />,
  report: <img src="/assets/report.png" alt="리포트" className="w-[96px] h-[96px]" />,
};
...
function MenuCard({ img, title, desc, link }) {
  return (
    <Link
      to={link}
      className="block bg-[#F5F6F7] w-[360px] h-[320px] rounded-xl shadow-md p-10 hover:shadow-lg transition-shadow duration-200 no-underline"
    >
