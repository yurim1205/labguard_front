    ...
    <div className="max-w-[1200px] mx-auto pt-10 pb-12">
      ...
      <section className="bg-[#ecece7] rounded-lg p-10 mb-10">
        <div className="border border-dashed border-[#b5b5b5] rounded-lg bg-[#FFFFFF] mt-[12px] min-h-[420px] flex flex-col items-center justify-center p-10 max-w-[520px] mx-auto">
          ...
          <label
            htmlFor="file-upload"
            className="inline-block bg-white text-[#234c36] border border-[#234c36] rounded px-6 py-2 font-semibold text-base cursor-pointer mt-2 transition-colors duration-200 hover:bg-[#234c36] hover:text-white"
          >
            파일 선택
          </label>
