  ...
  return (
    <>
      ...
      <div className="max-w-[1200px] mx-auto pt-10 pb-12">
        ...
        <h2 className="text-[20px] font-bold mb-0 text-left font-[500]">매뉴얼 등록</h2>
          <p className="text-[#7B87B8] text-base mt-1 mb-9 text-left">
        ...
        <section className="mt-14">
          <h2 className="text-[20px] font-bold mb-3 text-left">내 매뉴얼</h2>
