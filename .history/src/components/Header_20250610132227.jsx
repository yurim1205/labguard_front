...
function Header() {
  ...
  return (
    <header className="w-full h-[60px] bg-gradient-to-r from-[#5093F9] to-[#FFFFFF] m-0 p-0">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between py-4 px-8">
        <h1 className="items-center text-[#33308B] text-2xl font-extrabold tracking-widest m-0">LAB GUARD</h1>
