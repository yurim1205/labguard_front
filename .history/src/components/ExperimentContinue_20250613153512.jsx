...
const ExperimentContinue = () => {
  ...
  return (
    <div
      onClick={handleClick}
      className="h-[306px] w-[360px] border border-[#b5b5b5] rounded-[4px] shadow-sm p-5 cursor-pointer hover:shadow-md transition duration-200"
    >
      <div className="bg-[#F1F1ED] h-[160px] rounded-md mb-4 flex items-center justify-center border border-[#b5b5b5] mt-[20px]">
