  ...
  return (
    ...
    <div className="max-w-screen-xl mx-auto flex items-center justify-between px-8 h-full">
      ...
      <div className="flex-1">
        <h1 className="text-[#33308B] text-[24px] font-extrabold tracking-widest ml-[60px] whitespace-nowrap">
          LAB GUARD
        </h1>
      </div>
      ...
      <nav className="flex-1 flex justify-center gap-[128px] items-center">
        {menus.map((menu) => (
          <Link
            key={menu.to}
            to={menu.to}
            className={`text-[#1A237E] text-lg font-extrabold no-underline whitespace-nowrap transition-colors duration-200 ${
