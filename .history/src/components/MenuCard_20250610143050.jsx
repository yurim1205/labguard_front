...
const icons = {
  manual: <FaBook className="text-6xl text-[#6C3DD1]" size={48} />,
  lab: <FaFlask className="text-6xl text-[#6C3DD1]" size={48} />,
  report: <FaFileAlt className="text-6xl text-[#6C3DD1]" size={48} />,
};
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center h-full justify-between gap-6">
        <div className="bg-white rounded-md flex items-center justify-center mx-auto mb-6" style={{ width: "120px", height: "120px" }}>
          {icons[icon]}
        </div>
