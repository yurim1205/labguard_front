...
function MenuCard({ icon, title, desc, link }) {
  return (
    <Link
      to={link}
      className="block bg-[#000000] rounded-xl shadow-md p-10 w-80 min-h-[320px] hover:shadow-lg transition-shadow duration-200 no-underline"
    >
      <div className="flex flex-col items-center h-full justify-between gap-[12px]">
        <div>{icons[icon]}</div>
