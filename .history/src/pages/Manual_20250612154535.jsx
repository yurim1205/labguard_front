  ...
  return (
    <>
      ...
      <div className="max-w-[1200px] mx-auto pt-10 pb-12">
        ...
        <h2 className="text-[20px] font-bold text-left font-[500] mb-1">매뉴얼 등록</h2>
        <p className="text-[#7B87B8] text-base text-left mt-1 mb-6">
        ...
        <section className="bg-[#ecece7] rounded-lg p-10 mb-10 pt-[24px]">
          <div className="max-w-[520px] mx-auto">
            ...
            <div className="flex">
              <button
                className="rounded-t-lg px-9 py-3 font-bold text-[1.05rem] bg-[#234c36] text-white border border-[#b5b5b5] border-b-0"
              >
                실험
              </button>
            </div>
            ...
            {/* 업로드 박스 */}
            <div className="border border-[#b5b5b5] rounded-b-lg rounded-t-none bg-white shadow-[0_6px_12px_0_rgba(128,128,128,0.28)] min-h-[360px] flex flex-col items-center justify-center p-10 text-center gap-4">
              <div className="font-[600] text-[#0E467B] text-lg">첨부할 파일 놓기</div>
              <div className="text-base text-[#798483]">또는</div>
              <label
                htmlFor="file-upload"
                className="rounded-[3px] shadow-[0_6px_12px_0_rgba(128,128,128,0.28)] inline-block bg-white text-[#0E467B] border border-[#0E467B] px-6 py-2 font-semibold text-base cursor-pointer transition-colors duration-200 hover:text-white hover:bg-[#234c36]"
              >
                파일 선택
              </label>
            ...
            {/* 안내 텍스트 */}
            <ul className="text-[#888] text-sm mt-4 mb-[12px] text-left space-y-2">
              <li>파일 업로드는 PDF 형식만 가능하며, 용량은 30MB 이하로 제한됩니다.</li>
            </ul>
          </div>
        </section>
