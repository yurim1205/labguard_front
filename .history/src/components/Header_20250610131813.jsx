...
function Header() {
  ...
  return (
    <header className="w-full bg-gradient-to-r from-[#0D51B7] to-[#FFFFFF] m-0 p-0">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between py-4 px-8">
        <h1 className="text-[#1A237E] text-2xl font-extrabold tracking-widest m-0">LAB GUARD</h1>
