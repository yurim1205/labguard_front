      ...
      <div className="max-w-[1200px] mx-auto pt-10 pb-12">
        ...
        <div className="bg-white border border-[#E6EEFF] rounded-lg p-4 mb-6 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm text-[#7B87B8]">
              실험 시작 시간: {new Date(experimentStartTime).toLocaleString('ko-KR')}
            </div>
          </div>
        </div>
       ...
       {messages.map((msg, index) => (
        ...
        <div className="flex justify-center mt-8">
          <button
            onClick={handleExperimentEnd}
            className="bg-[#FF6B6B] hover:bg-[#FF5252] text-white font-bold py-3 px-8 rounded-lg shadow-md transition-colors"
          >
            실험 종료
          </button>
        </div>
