...
function MenuCard({ img, title, desc, link }) {
  ...
  return (
    <Link
      to={link}
      className="block bg-[#EBEAE5] w-[360px] h-[320px] rounded-[5px] shadow-md p-10 hover:shadow-lg transition-shadow duration-200 no-underline"
    >
      <div className="flex flex-col items-center h-full justify-between gap-6">
        <div
          className="bg-[#FFFFFF] rounded-md flex items-center justify-center mx-auto mb-6 mt-[12px]"
